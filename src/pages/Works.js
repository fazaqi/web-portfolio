            ...
            <div className="desktop">
                ...
                <div className="works_desc right">
                  ...
                  <div className="desc">
                    <p>
                      ...
                      in marketplace to gudangin so you can organize your
                      stores, orders, products, stocks, and chat from all your
              ...
              <div className="row items align-items-center">
                <div className="works_desc">
                  ...
                  <div className="desc">
                    <p>
                      A website for a community. In this website you can collect
                      a point which called 'Baper Poin' by playing games,
